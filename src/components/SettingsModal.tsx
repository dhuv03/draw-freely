    ...
    <section className="settings-modal" role="dialog" aria-modal="true" aria-label="Settings" onPointerDown={(event) => event.stopPropagation()}>
      ...
      <div className="settings-layout">
        ...
        <main>
          ...
          {tab === 'help' && <section><h3>Help</h3><p>Click an active tool again to reopen or close its settings. On desktop, use the six-dot handle to reposition the toolbar. Press Escape to return to Select.</p></section>}
        </main>
      </div>
    </section>
  </div>;
